...
export default function Home() {
  ...
  function addProposition() {
    ...
    if (classSelected2 != "0" || classSelected2.substring(0, pos) == "0") {
      const body = {
        id: idUser,
        nameClass: classSelected2.substring(pos + 1),
        token: token,
      };
      ...
      toast.error(
        "Il faut sélectionner un cours pour ajouter une proposition de tutorat.",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  const deleteProposition = (event: { currentTarget: { id: any } }) => {
    const body = {
      id: idUser,
      nameClass: event.currentTarget.id,
      token: token,
    };
    ...
    <div className="h-screen grid grid-cols-2">
      <div className="font-face-pg flex flex-col items-center">
        ...
        <div className="flex mx-4">
          ...
          <TuteurDropDown
            id={classSelected1.substring(0, pos)}
            onChanged={changeTutor}
      ...
      <div className="flex flex-col items-center font-face-pg">
        ...
        <div className="flex items-center">
          ...
          <button
            className="bg-blueTheme text-white font-bold mx-2 px-8 py-2 rounded mt-1 mb-4"
        ...
        <div className="overflow-y-scroll h-1/4 scrollbar-thin scrollbar-thumb-blueTheme scrollbar-track-blue-300 flex flex-col items-center w-1/2">
          {propositions.map((proposition) => {
            return (
              ...
              >
                <p className="text-center text-xs col-start-3 col-end-5">
                  {proposition["name"]}
                </p>
                <button
                  id={proposition["name"]}
                  ...
                  className="col-end-7"
                >
                  <img src={"images/block.png"} className="w-8" />
                </button>
              </div>
            );
          })}
        ...
        <div className="overflow-y-scroll h-2/5 scrollbar-thin scrollbar-thumb-blueTheme scrollbar-track-blue-300 items-center">
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-end">
                  <button id={request["id"]} onClick={activeRequest}>
                    <img
