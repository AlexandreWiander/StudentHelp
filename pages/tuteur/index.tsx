                        ...
                        if (isActive) {
                            return (
                                <div key={request["id"]}
                                    ...
                                    <img src={"/images/avatar/" + request["avatarTutor"] + ".png"} className="w-40 col-start-1 col-end-2"/>
                                    ...
                                    <div className="col-start-6 flex items-center">
                                        <button id={request["id"]} onClick={deleteRequest}><img src={"images/block.png"} className="w-20"/></button>
                                        <Link
                                            href={{
